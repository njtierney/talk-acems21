...
# .large[Making Better Spaghetti (plots)]

<br> <br>

## Nicholas Tierney
## Telethon Kids Institute, Perth, Australia
## ACEMS ECR Retreat, 2nd November, 2021

`r icons::icon_style(icons::fontawesome(name = 'link', 'solid'), fill = nipa$purple)` **njt-acems21.netlify.app** 
...
# Two problems in exploring longitudinal data 
...
`r icons::icon_style(icons::fontawesome$solid$code, fill = nipa$purple)` Work with `dplyr::across()`
]
...
.large[
`r icons::icon_style(icons::fontawesome(name = "box-open", "solid"), fill = nipa$purple) ` [brolgar.njtierney.com](http://brolgar.njtierney.com/) (Now on CRAN)

`r icons::icon_style(icons::fontawesome$solid$link, fill = nipa$purple)` [njt-acems21.netlify.app](https://njt-acems21.netlify.app)
